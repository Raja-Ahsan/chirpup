...
class CastleCompleteView extends StatefulWidget {
  const CastleCompleteView({super.key});

  @override
  State<CastleCompleteView> createState() => _CastleCompleteViewState();
}

class _CastleCompleteViewState extends State<CastleCompleteView> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              "assets/png/castle_build_complete_bg.png",
              fit: BoxFit.cover,
            ),
          ),
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Image.asset(
                              'assets/png/complete_castle.png',
                            ),
                          ),
